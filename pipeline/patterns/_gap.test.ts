...
test('tight 1-day gap under calendar null scores p < 0.2', () => {
...
test('calendar mode without window bounds throws (no silent NaN)', () => {
  assert.throws(
    () => perPairLowerTail({
      trades: [T('t1', '2024-06-03', 'tech')],
      votes: [V('v1', '2024-06-04', 'tech')],
      windowDays: 90,
      observed: new Map([['t1', 1]]),
      nPerm: 10,
      rng: mulberry32(1),
      mode: 'calendar',
    }),
